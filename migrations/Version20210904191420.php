 ...
 */
final class Version20210904191420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD type_id INT DEFAULT NULL, ADD filter_continent_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP type_id, DROP filter_continent_id');
    }
}
